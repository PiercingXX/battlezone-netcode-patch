...
3. Start logging: `& "$HOME\Downloads\Battlezone Netcode Patch\Microslop\tester_diag.ps1" -Action Start`
4. Play and exit game.
5. Stop logging: `& "$HOME\Downloads\Battlezone Netcode Patch\Microslop\tester_diag.ps1" -Action Stop`
...
```powershell
& "$HOME\Downloads\Battlezone Netcode Patch\Microslop\tester_diag.ps1" -Action Start
```
...
```powershell
& "$HOME\Downloads\Battlezone Netcode Patch\Microslop\tester_diag.ps1" -Action Stop
```
